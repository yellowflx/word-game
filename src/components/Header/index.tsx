...
export const Header = () => {
  ...
  return (
    <HeaderWrapper>
      <HeaderContent>
        <div>
          <a href="https://github.com/YellowFLX/word-game" title="Исходный код (GitHub)" target="_blank"
             rel="noreferrer">
 ...
 1.653.242 2.874.118 3.176.77.84 1.235 1.9111.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823
